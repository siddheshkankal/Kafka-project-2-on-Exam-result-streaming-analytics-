        ...
        try:
            ...
            if exam is not None:
                ...
                if exam.record['group'] == 'group A':
                    export_data_excel(header,data,'./first_consumer_output/group_A_date.csv')
                if exam.record['group'] == 'group B':
                    export_data_excel(header,data,'./first_consumer_output/group_B_date.csv')
                if exam.record['group'] == 'group C':
                    export_data_excel(header,data,'./first_consumer_output/group_C_date.csv')
                if exam.record['group'] == 'group D':
                    export_data_excel(header,data,'./first_consumer_output/group_D_date.csv')
                if exam.record['group'] == 'group E':
                    export_data_excel(header,data,'./first_consumer_output/group_E_date.csv')
